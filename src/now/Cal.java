	...
	//boolean m=false;
		...
		// String d;
    		...
    		public void start (Stage primaryStage){
    			...
    			Button viewBT=new Button("history");
    			viewBT.prefWidthProperty().bind(mainPane.widthProperty().divide(2));
    			viewBT.prefHeightProperty().bind(mainPane.heightProperty().divide(15));
    			viewBT.setFont(Font.font("Times New Roman",
    					 FontWeight.BOLD, FontPosture.ITALIC, 12));
    			viewBT.styleProperty().bind(
    				      Bindings
    				        .when(viewBT.hoverProperty())
    				          .then(
    			...
    			Button editBT=new Button("approximate");
    			editBT.prefWidthProperty().bind(mainPane.widthProperty().divide(2));
    			editBT.prefHeightProperty().bind(mainPane.heightProperty().divide(15));
    			editBT.setFont(Font.font("Times New Roman",
    					 FontWeight.BOLD, FontPosture.ITALIC, 12));
    			editBT.styleProperty().bind(
    				      Bindings
    				        .when(editBT.hoverProperty())
    				          .then(
    				            new SimpleStringProperty("-fx-color: gray;")
    				          )
    				          .otherwise(
    			...
    			HBox hb=new HBox(10);
    			hb.getChildren().addAll(viewBT,editBT);
    			
    			/*Button clearBT=new Button("clear");
    			clearBT.prefWidthProperty().bind(mainPane.widthProperty());
    			clearBT.setFont(Font.font("Times New Roman",
    					 FontWeight.BOLD, FontPosture.ITALIC, 12));
    			clearBT.styleProperty().bind(
    				      Bindings
    				        .when(clearBT.hoverProperty())
    				          .then(
    				            new SimpleStringProperty("-fx-color: gray;")
    				          )
    				          .otherwise(
